...
export function renderChat(root){
  ...
  async function callModel(prompt){
    ...
    try{
      ...
      {
        const openaiKey = window.OPENAI_API_KEY || util_getEnv('VITE_OPENAI_API_KEY','VITE_OPENAI_API_KEY') || util_getEnv('OPEN_AI_API','OPEN_AI_API') || util_getEnv('OPENAI_API_KEY','OPENAI_API_KEY') || '';
